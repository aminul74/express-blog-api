...
describe("Blog Services", () => {
  ...
  describe("processUpdateBlog", () => {
    it("Test Case 1: Blog Update Success!", async () => {
      ...
      const blogUUID = "uuid-123";
      const isValidBlog = blogsDB[1];
      const processToUpdateBlog = blogsDB[1];
      // Mock
      blogRepositories.findBlogByAuthUser.mockResolvedValue(isValidBlog);
      blogRepositories.updateBlogById.mockResolvedValue(processToUpdateBlog);
      ...
      expect(result).toEqual(processToUpdateBlog);
    });
